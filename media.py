...
class Video:
    ...
    def __init__(self, title, duration, year, rating, video_type,
        ...
        self.duration = duration  # duration of the video, hours min.
...
class Movie(Video):
    """ Inherits from class Video. Defines the class Movie. Creates any kind of
        movie.
        Attributes:
...
class TvShow(Video):
    ...
    """
    def __init__(self, title, duration, year, season, episode, tv_station,
                 rating, storyline, poster_image_url, trailer_youtube_url,
                 video_type):
                Video.__init__(self, title, duration, year, rating, video_type,
