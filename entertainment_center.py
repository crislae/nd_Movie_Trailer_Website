# -*- coding: cp1252 -*-
"""
    Title:	    "entertainment_center.py" Nanodegree project: Movie Trailer
                    Website
    Author:         crislae @github
    Content:        Initialiates, with real examples of movies, the Media Data
                    and it creates the movie trailer website.
                    The movie pictures URLs and the videos URLs have been
                    obtained from the Internet. Videos URLs from Youtube,
                    pictures URLs from wikimedia.
    Status:	    to be submitted and evaluated - nanodegree Full Stack Web
                    Developer
    Created:	    01-Jul-2017
...
PG13 = "Parental Guidance-13, with parents strongly cautioned, as some " \
       "material may not be suitable for children under 13"
R = "Restricted, with no one under 17 admitted without an accompanying " \
    "parent or guardian"
...
indianaJones2 = media.Movie("Indiana Jones and the Temple of Doom",
                            ...
                            PG,
                            ac+" "+ad+" "+f,
                            "Filming Locations: University of the Pacific, " +
...
indianaJones3 = media.Movie("Indiana Jones and the Last Crusade",
                            ...
                            PG,
                            ac+" "+ad+" "+f,
                            "Filming Locations: Palazzi Barbaro, Grand " +
                            "Canal Venice, Veneto, Italy...")

lion_king = media.Movie("The Lion King",
                        "1h 28min",
                        "1994",
                        "The Lion King tells the story of Simba, a young " +
                        "lion who is to succeed his father, Mufasa, as King " +
                        "of the Pride Lands",
...
aladdin = media.Movie("Aladdin",
                      "1h 30min",
                      "1992",
                      "The adventures of Aladdin, a poor street thief who " +
                      "spends his time stealing food from the marketplace " +
...
beauty_and_the_beast = media.Movie("Beauty and the Beast",
                                   "1h 24min",
                                   "1991",
                                   "The Disney story about a beauty and a " +
                                   "beast, animated and musical. The film is" +
                                   " based on the fairy tale La Belle et la " +
                                   "Bete...",
...
the_goonies = media.Movie("The Goonies",
                          "1h 54min",
                          "1985",
                          "A group of kids set out on an adventure in search" +
                          " of pirate treasure...",
...
princess_bride = media.Movie("The Princess Bride",
                             "1h 38min",
                             "1987",
                             "Story about a farmhand named Westley who must " +
                             "rescue his true love Princess Buttercup from " +
                             "the odious Prince Humperdinck.",
...
back_to_the_future = media.Movie("Back to the Future ",
                                 "1h 56min",
                                 "1985",
                                 "Marty McFly is accidentally sent 30 years " +
                                 "into the past in a time-traveling DeLorean" +
                                 " invented by the scientist Doc Brown",
...
gamesofthroess01e01 = media.TvShow("Game of Thrones, S01E01: Winter Is Coming",
                                   ...
                                   "HBO",
                                   PG13,
                                   "The series is based on A Game of Thrones" +
                                   ", the first novel in the A Song of Ice " +
                                   "and Fire series by George R. R. Martin",
